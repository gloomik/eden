/* src/config/eden-config.h.  Generated from eden-config.h.in by configure.  */
/* src/config/eden-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EDEN_CONFIG_H

#define EDEN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/edenpay/eden/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eden"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eden 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eden"
